...
A web application for managing contacts with **CRUD operations, database integration, authentication, validation, searching, filtering, Excel import, and data export**.
...
- Search contacts by:
  ...
  - Country
  - Address
- Filter and sort contact data
- User registration and login
- User and Admin roles
- Server-side and client-side validation
- Asynchronous AJAX validation during registration
...
- **ServiceContracts** – Service interfaces and DTO contracts
- **Services** – Business logic and data-access operations
- **ContactsManager** – ASP.NET Core MVC web application
- **CRUDTests** – Unit tests for CRUD operations
...
## Excel Import & Data Export

Contacts can be imported from Excel and exported into multiple formats.
...
The solution contains a separate **CRUDTests** project for testing CRUD-related functionality.

Run the tests from Visual Studio Test Explorer or with:
